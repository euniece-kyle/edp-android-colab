    ...
    Card(Modifier.fillMaxWidth()) {
        Column(
            ...
            PermissionGate(
                ...
                // TODO 9a: CameraPreview (with TODO 14 preview callback extension)
                CameraPreview(
                    capture = capture,
                ...
                // TODO 9c: Saved status label
                photo?.let { Text("Saved: ${it.name}") }

                // TODO 13: Shake capture logic
                ...
                // TODO 14: Torch toggle button using CameraControl
